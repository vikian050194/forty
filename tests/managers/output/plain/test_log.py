...
class OutputPlainLog(OutputPlainTestCase):
    def test_one_action(self, mock_print):
        ...
        mock_print.assert_called_with("start 2022-04-24T09:00:17")
    ...
    def test_two_actions(self, mock_print):
        ...
        self.assertEqual(actual_invocations, expected_invocations)
        self.assertEqual(mock_print.call_args_list[0], call("start 2022-04-24T09:00:17"))
        self.assertEqual(mock_print.call_args_list[1], call("finish 2022-04-24T17:38:58"))
        mock_print.reset_mock()
